...
class LoginModel{
    ...
    function enviarCorreo($email){
        ...
        $msg = $nombre." entra al siguiente enlace para recuperar tu contrase√±a en la tienda virtual<br>";
        ...
        try {
            ...
            $mail->Subject = 'Cambio de contraseè´–a'; //asunto
            $mail->Body = $msg; //
    ...
    function verificar($email, $clave){
        ...
        if(empty($datas)){
            ...
            array_push($errores,"contrase√±a no valida");
        }
        return $errores;
    }
}
